            ...
            {currentRows.map((row, rowIndex) => (
              <tr key={rowIndex}>
                {columns.map((column, colIndex) => (
                  <td
                    key={colIndex}
                    className={` px-4 text-center border-b-[1px] border-b-gray-300 py-2 text-gray-600 text-sm font-[500] ${rowIndex % 2 === 0 ? "bg-white" : "bg-white"
                      }`}
                  >
                    {column === "Actions" ? (
    ...
    <div className="w-[50px] h-[50px] mx-auto">
      ...
      />
                      ...
                      <div
                        ...
                        onClick={() => updateCommissionStatus(row)}
                      >
                        {row[column]}
                      </div>
                    ) :

...
import SaleItemsAccessoriesShop from "./CreateAccessoriesSaleBill"
import CustomModal from "../../../common/CustomModal";
import CustomPopup from "../../../common/CustomPopup";
import { useDeleteAccessoriesSaleMutation, useGetAllSaleAccessoriesQuery } from "../../../../features/Api";
import { showToast } from "../../../common/CustomToast";


function AccessoriesMonthlySales() {
  const [isOpen, setIsOpen] = useState(false)
  const [showDeletePopup, setShowDeletePopup] = useState(false);
  const [selectRecordIndex, setSelectRecordIndex] = useState(null);
  const [deleteAccessoriesSale, { isLoading: isDeleting }] = useDeleteAccessoriesSaleMutation();
  const { data: monthlySalesData = [] , refetch  : refetchDelete  } = useGetAllSaleAccessoriesQuery("month");
...
export default AccessoriesMonthlySales;

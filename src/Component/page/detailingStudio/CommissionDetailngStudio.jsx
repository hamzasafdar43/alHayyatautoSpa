...
function CommissionDetailngStudio() {

  const [selectedcarWasher , setSelectedcarWasher] = useState("")

 const {data :allBills = [] } = useGetAlldetailingStudioBilQuery()
  ...
  const columns = ["Sr_No","Date" , "Detailing_Master" , "Commission"]
...
export default CommissionDetailngStudio